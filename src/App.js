...
const App = () => {
  ...
  const determineweatherurl = () => {
    let imurl =
      "https://png.pngtree.com/background/20230427/original/pngtree-clouds-above-a-bright-sky-picture-image_2494866.jpg"; // default value

    if (description.includes("clear")) {
      imurl = "https://t4.ftcdn.net/jpg/05/79/25/43/360_F_579254301_VQ75mtrG9AP45Txrd76TG2xatiBqqms2.jpg";
    }
    ...
    if (description.includes("smoke")) {
      imurl = "https://c0.wallpaperflare.com/preview/906/687/614/sky-clouds-nature-weather.jpg";
    }
    ...
    if (description.includes("fog")) {
      imurl =
        "https://images.unsplash.com/photo-1487621167305-5d248087c724?q=80&w=1932&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D";
    }
    if (description.includes("haze")) {
      imurl = "https://eoimages.gsfc.nasa.gov/images/imagerecords/145000/145827/globeindiasmog_lrg.jpg";
    }
    if (description.includes("mist")) {
      imurl = "https://images.nationalgeographic.org/image/upload/v1638884972/EducationHub/photos/blue-mist.jpg";
    }
    if (description.includes("dust")) {
      imurl = "https://www.aoa.org/AOA/Images/News_2020/dust-cloud900.jpg";
    }
    if (description.includes("sand")) {
      imurl =
    ...
    if (description.includes("ash")) {
      imurl = "http://i.cdn.turner.com/cnn/2011/WORLD/americas/06/19/chile.volcano/t1larg.chile.volanco.ash.afp.gi.jpg";
    }
    if (description.includes("squalls")) {
      imurl = "https://www.weatherzone.com.au/news-thumbnail/2941205";
    }
    if (description.includes("tornado")) {
      imurl = "https://images.pexels.com/photos/1446076/pexels-photo-1446076.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1";
    }
  ...
  const callbylatlon = async () => {
    if (latitude.length !== 0 && longitude.length !== 0) {
      await Axios.get(`https://api.openweathermap.org/data/2.5/weather?lat=${latitude}&lon=${longitude}&appid=${apiKey}`)
        .then(({ data }) => {
